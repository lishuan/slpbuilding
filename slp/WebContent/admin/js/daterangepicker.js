...
!function ($, moment) {
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        var DRPTemplate = '<div class="daterangepicker dropdown-menu"><div class="datetopfudong"></div>' +
    ...
    DateRangePicker.prototype = {
        ...
        setOptions: function(options, callback) {
            ...
            if (this.singleDatePicker) {
				this.container.addClass("singleDatePicker");
                this.opens = 'right';
                this.container.find('.calendar.right').show();
                this.container.find('.calendar.left').hide();
				this.startDate = moment().subtract('days');
        ...
        move: function () {
			...
			input_left=this.element.offset().left;//INPUT（日历要显示的）距BODY左距离
			date_left=this.container.offset().left;//日历距BODY左距离
			this.container.find(".datetopfudong").css("margin-left",input_left-date_left);
        },
        ...
        show: function (e) {
            this.element.addClass('active date-lyh');
            this.container.show();
            this.move();
        ...
        hide: function (e) {
            ...
            this.element.removeClass('active date-lyh');
            this.container.hide();
        ...
        renderCalendar: function (calendar, selected, minDate, maxDate) {
            ...
            if (!minDate || minDate.isBefore(calendar[1][1])) {
                html += '<th class="prev available"><i class="date-arrow-left"></i></th>';
            } else {
                html += '<th></th>';
            }
            ...
            if (!maxDate || maxDate.isAfter(calendar[1][1])) {
                html += '<th class="next available"><i class="date-arrow-right"></i></th>';
            } else {
                html += '<th></th>';
            }
