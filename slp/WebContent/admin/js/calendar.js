...
Calendar.prototype.draw = function() {
	...
	_cs[_cs.length] = '  <th colspan="2"><select class="year" name="yearSelect" id="yearSelect"><\/select></th><th colspan="2"><select class="month" name="monthSelect" id="monthSelect"><\/select><\/th>';
...
document.writeln('<div id="__calendarPanel" style="position:absolute;visibility:hidden;z-index:9999;background-color:#FFFFFF;border:1px solid #666666;width:210px;height:216px;">');
